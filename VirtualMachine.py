class VirtualMachine:
    ...
    def getValueInMemory(self, dir):
        # Global memory map
        if dir >= 1000 and dir < 1500:
            return self.memGlobal.int[dir - 1000]
        elif dir >= 1500 and dir < 2000:
            return self.memGlobal.float[dir - 1500]
        elif dir >= 2000 and dir < 2500:
            return self.memGlobal.char[dir - 2000]
        elif dir >= 2500 and dir < 3000:
            return self.memGlobal.bool[dir - 2500]
    ...
    def assignValue(self, dir, left_op_dir):
        ...
        if dir >= 1000 and dir < 1500:
            ...
            self.memGlobal.float[dir - 1500] = left_op_dir
        elif dir >= 2000 and dir < 2500:
            self.memGlobal.char[dir - 2000] = left_op_dir
        elif dir >= 2500 and dir < 3000:
            self.memGlobal.bool[dir - 2500] = left_op_dir
